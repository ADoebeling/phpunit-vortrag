...
class GoodExampleTest extends \PHPUnit_Framework_TestCase
{
	public function testProcessForm()
	{
		$handlerMock = $this->getMock('Chapter3\DependencyOne');
	...
	{
		$depMock = $this->getMock('Chapter3\DependencyTwo');
	...
	{
		$depMock = $this->getMock('Chapter3\DependencyInterface');
